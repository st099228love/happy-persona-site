window.RESULT_TYPES = {
  'high-independent-utilitarian': {
    ...
    combo: '實體高 × 獨立 × 功利',
    shortTag: '任何事都不希望被耽誤',
    description: '你不太喜歡被打斷的感覺，尤其是在你已經想好今天要怎麼安排的時候。很多時候你不是不喜歡人，而是覺得等待、協調、配合，會很搞剛。當你一個人行動時，你會比較安心，因為事情能照自己的步調走，該看什麼、待多久、什麼時候離開，都很清楚。'
  },
  'high-independent-selfNurturing': {
    ...
    description: '你很需要一段完全不被打擾的時間，尤其是在忙碌、內耗，或情緒很多的時候。你可能會發現，自己一個人反而比較容易放鬆，也比較能重新喜歡上現在的自己。對你來說，獨處不是孤單，而是一種溫柔的充電方式。'
  },
  ...
  'high-interdependent-selfNurturing': {
    ...
    description: '你其實很重視人和連結，只是有時候在關係裡待久了，會不自覺有點累。你需要的不是完全抽離，而是一段可以讓自己慢下來、重新穩定下來的時間。對你來說，暫時退開不是逃避，而是一種很自然的整理。'
  },
  ...
  'low-independent-selfNurturing': {
    ...
    combo: '實體低 × 獨立 × 自我滋養',
    shortTag: '外面怎樣不是重點，我的內在有進入狀態就好',
    description: '你很能在自己的世界裡待著，即使旁邊有人，也不太容易被影響。對你來說，真正重要的不是外在環境多厲害，而是當下有沒有進入自己的節奏。有時候你只需要一個地方坐下來，就能很專注、很平靜，甚至有點忘記時間。'
  },
  ...
  'low-interdependent-selfNurturing': {
    ...
    combo: '實體低 × 相依 × 自我滋養',
    shortTag: '我不是想完全一個人，我只是想要剛剛好的陪伴感',
    description: '你不是真的想要完全一個人，而是比較喜歡那種「有人在，但不打擾」的感覺。有時候只要周圍有一點人群聲音，你反而更放鬆。你需要的不是孤立，而是一種背景式的陪伴感，讓你可以安靜做自己，但又不會覺得太空。'
  }
};

window.SPOT_POOL = {
  spot01: { title: '台南知事官邸散步＋曖寒光豆腐煲', icon: '🫶', detail: '先在知事官邸附近慢慢走走，再去吃一份熱熱的豆腐煲，整體節奏舒服，適合想把自己慢慢安頓下來的時候。' },
  spot02: { title: '赤崁樓餵魚＋武廟好好問個事', icon: '⛩️', detail: '適合想一邊走、一邊整理思緒。先餵魚放空，再到武廟把最近卡住的事安靜想一遍。' },
  spot03: { title: '笑笑羊福爾摩沙酒店，純粹喜歡笑笑羊', icon: '🐑', detail: '如果你只是想單純去看自己喜歡的東西、被可愛療癒一下，這種沒有壓力的行程很剛好。' },
  spot04: { title: '成大綠色魔法學校看拚舟綠花園', icon: '🌿', detail: '可以短暫抽離日常，看看綠意、換個呼吸節奏，適合需要一點清爽感的時候。' },
  spot05: { title: '成大歷史文物博物館看瓷器＋成大消費合作社買短T', icon: '🏺', detail: '這種有明確目標、也有順手完成事情感的路線，很適合喜歡一趟出門有內容也有收穫的人。' },
  spot06: { title: '成大總圖古籍展覽＋3D-5F新空間＋品藏小館蛋沙拉吐司＋借《人類大歷史》', icon: '📚', detail: '這是一種可以安靜待很久、慢慢沉進自己節奏裡的行程。你可以看展、看書、坐著發呆，也可以讓時間過得很安靜。' },
  spot07: { title: '衛保組量 InBody＋了解 BK24 蒸汽火車歷史', icon: '🚂', detail: '一邊掌握自己身體狀態，一邊接觸一點有內容的東西，適合喜歡清楚目的感的人。' },
  spot08: { title: '成大學生會枕頭大戰', icon: '🛏️', detail: '比較像是讓自己動起來、鬧一下、釋放一下能量的活動。很適合偶爾想換氣氛的人。' },
  spot09: { title: '青春放風曬生活市集｜誠品生活台南', icon: '🛍️', detail: '有人氣，但不用硬社交。可以自己慢慢逛，也可以停在喜歡的攤位前，整體很自由。' },
  spot10: { title: '台南電影狸想世界電影', icon: '🎬', detail: '如果你本來就對一個人看電影有感，這類行程很適合讓自己安靜進入情緒和故事裡。' },
  ...
  spot13: { title: '創意積木夢工場｜LEGO 樂高', icon: '🧱', detail: '有點玩心、有點投入感，也很適合讓腦袋暫時切換到比較輕鬆的模式。' },
  ...
  spot21: { title: '土星工作室〈顆粒〉花磚小展覽＋吳園散步餵魚', icon: '🪷', detail: '有小展覽、有散步、有停留感，整體很溫柔，很適合喜歡慢慢走、慢慢看的你。' },
  spot22: { title: '衝極商店＋無名米糕', icon: '🍚', detail: '有點街頭感、有點生活感，可以邊走邊看、順手吃點東西，整體很隨性。' },
  spot23: { title: '溫刀鐵道＋西市場＋政大書城', icon: '🚞', detail: '這條線很適合喜歡自己掌控節奏的人，有老味道、有書店、有逛的空間，也不會太亂。' },
  spot24: { title: 'takara 可愛雜貨店＋不不看漫畫讀書不限時', icon: '📖', detail: '可以先逛可愛的東西，再去安靜坐著看書或漫畫，適合慢慢泡進自己世界裡。' },
  spot25: { title: '府城陶坊玩土 $100，成品帶回家燒製後 $250', icon: '🏺', detail: '手作很適合把注意力收回自己身上，也會有一種慢慢被安定下來的感覺。' },
